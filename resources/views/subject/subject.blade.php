...
<body id="body-pd" class="bg-white">
    ...
    @endif
        <h4 class="text-center">Show Subjects</h4>
                ...
                @foreach ($subjects as $subject)
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('editSubject', $subject->id) }}" class="text-warning"><i
                                        class="bx bx-edit h4"></i></a>
                                <a href="{{ route('deleteSubject', $subject->id) }}" class="text-danger"><i class="bx bx-trash h4"></i></a>
                            </td>
                        </tr>
                    </tbody>
                @endforeach
