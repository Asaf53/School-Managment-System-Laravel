...
<body id="body-pd" class="bg-white">
    ...
    <div class="bg-white p-5">
        <h4 class="text-center mb-5">Edit Subject</h4>
        <div class="d-flex justify-content-center align-items-center">
            <form method="post" action="{{ route('updateSubject', $subject->id) }}" class="w-25">
                @csrf
                <div class="mb-3">
                    <label for="subjectName" class="form-label">Subject Name</label>
                    <input type="text" name="subjectName" id="subjectName" value="{{ $subject->name }}"
                ...
                <div class="mb-3">
                    ...
                    class="form-select @error('teacher')
                            is-invalid
                        @enderror">
                        <option value="{{ $subject->teacher_id }}">Select Teacher</option>
