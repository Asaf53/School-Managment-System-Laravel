    ...
    <body id="body-pd" class="bg-white">
                ...
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <div class="collapse" id="teacher">
                            <a href="#" class="nav_link">Show Teachers</a>
        ...
        <div class="bg-white p-5">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <form method="post" action="{{route('updateStudent')}}" class="w-25">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime" name="registered" id="registered" class="form-control" value="{{$student->registered}}">
                    </div>
                    <div class="mb-3">
