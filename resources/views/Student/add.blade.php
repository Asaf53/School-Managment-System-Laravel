...
<body id="body-pd" class="bg-white">
    ...
    <div class="bg-white p-5">
        <h4 class="text-center mb-5">Add Student</h4>
        <div class="d-flex justify-content-center align-items-center">
            <form method="post" action="{{ route('storeStudent') }}" class="w-25">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="dateOfBirthday" id="dateOfBirthday"
                        class="form-control @error('dateOfBirthday')
                            is-invalid
                        @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="registered" id="registered"
                        class="form-control @error('registered')
                            is-invalid
                        @enderror">
                    @error('registered')
                        <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="parentName" id="parentName"
                        class="form-control @error('parentName')
                            is-invalid
                        @enderror">
                    @error('parentName')
                        <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <select name="classroom" id="classroom"
                        class="form-select @error('classroom')
                            is-invalid
                        @enderror">
