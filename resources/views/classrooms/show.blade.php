...
<body id="body-pd" class="bg-white">
    ...
    <div class="bg-white mt-5 p-5">
        ...
        @endif
        <h4 class="text-center">Show Classroom</h4>
                ...
                @foreach ($classrooms as $classroom)
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('editClassroom', $classroom->id) }}" class="text-warning"><i class="bx bx-edit h4"></i></a>
                                <a href="{{ route('deleteClassroom', $classroom->id) }}" class="text-danger"><i class="bx bx-trash h4"></i></a>
                            </td>
                        </tr>
                    </tbody>
                @endforeach
